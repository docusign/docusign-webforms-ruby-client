...
module DocuSign_WebForms
  ...
  class WebFormContent
    ...
    def self.swagger_types
      {
        :'components' => :'Hash<String, Hash<String, Object>>',
        :'is_standalone' => :'BOOLEAN',
        :'brand_id' => :'String',
        :'templates' => :'Array<TemplateProperties>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isStandalone')
        self.is_standalone = attributes[:'isStandalone']
      end
    ...
    def hash
      [components, is_standalone, brand_id, templates].hash
    end
